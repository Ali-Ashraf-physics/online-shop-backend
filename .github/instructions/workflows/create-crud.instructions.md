...
Create CRUD only when the domain supports CRUD. Use soft archive for business records where deletion is unsafe. Include admin/public controller split where appropriate.
