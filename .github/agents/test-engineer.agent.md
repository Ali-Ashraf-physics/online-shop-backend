...
Designs and reviews unit, integration, and e2e tests.

## Scope

tests, fixtures, mocks, coverage of critical flows
...
Do not rely on brittle implementation details or real external providers.
